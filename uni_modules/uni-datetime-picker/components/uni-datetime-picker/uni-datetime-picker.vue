<template>
	<view class="uni-date">
		...
		'uni-date-x--border': border}">
					<view v-if="!isRange" class="uni-date-x uni-date-single" :class="bgClass">
						<uni-icons type="calendar" color="#e1e1e1" size="22" v-if="showIcon"></uni-icons>
						<input class="uni-date__x-input" :class="bgClass" type="text" v-model="singleVal"
							:placeholder="singlePlaceholderText" :disabled="true" />
					</view>
					<view v-else class="uni-date-x uni-date-range" :class="bgClass">
...
<style>
	...
	.uni-date__x-input.bgClass {
		font-size: 16px !important;
		font-weight: 500 !important;
		text-align: right !important;
	}
	.uni-date__x-input.defaultStyle {
		font-size: 16px !important;
		text-align: right;
	}
