					...
					<swiper-item>
						<view class="swiper-content">
							...
							<view class="search-content">
									...
									<input type="text" :auto-blur="true" v-model="startInputVal" @input="startInput" placeholder="请输入市/直辖市" class="search-input" />
