...
<view>
	...
	<!-- <movable-area class="movable-area">
		<movable-view class="scroll" :style="'height: calc(100vh - 50rpx + 40rpx + ' + refreshSize + 'rpx)'" @change="change" @touchend="touchend" direction="vertical" :disabled="refreshStatus >= 3" :y="move" ref="movable_view"> -->
			<scroll-view class="scroll__view" :style="'padding-bottom: ' + bottomSize + 'rpx;padding-top: ' + topSize + 'rpx;'" :scroll-y="refreshStatus == 1" @scroll="scroll" :scroll-top="scrollTop" :lower-threshold="80 + 'rpx'" @scrolltolower="more">
				...
				<view v-if="listCount !== 0 && overOnePage" 
        :class="isOrder ? 'scroll__bottom_order' : 'scroll__bottom'"
        >
